...
musicOne = \fixed c' {
  ...
  \time 4/4
  \repeat volta 2 {e4 e4 f4 g4 g4 f4 e4 d4 | c4 c4 d4 e4 \alternative{{e4. d8 d4}{d4. c8 c4}} r4}\break
...
verseOne = \lyricmode {
  ...
  \new Lyrics {
    ...
    wir be -- tre -- ten feu -- er -- trun -- ken himm -- lisch -- e dein _ _ _ Hei -- lig -- tum!
  }
>>
